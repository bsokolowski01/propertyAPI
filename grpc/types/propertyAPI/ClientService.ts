...
import type { DeleteClientResponse as _propertyAPI_DeleteClientResponse, DeleteClientResponse__Output as _propertyAPI_DeleteClientResponse__Output } from '../propertyAPI/DeleteClientResponse';
...
export interface ClientServiceClient extends grpc.Client {
  ...
  DeleteClient(argument: _propertyAPI_ClientId, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  DeleteClient(argument: _propertyAPI_ClientId, metadata: grpc.Metadata, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  DeleteClient(argument: _propertyAPI_ClientId, options: grpc.CallOptions, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  DeleteClient(argument: _propertyAPI_ClientId, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  deleteClient(argument: _propertyAPI_ClientId, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  deleteClient(argument: _propertyAPI_ClientId, metadata: grpc.Metadata, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  deleteClient(argument: _propertyAPI_ClientId, options: grpc.CallOptions, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
  deleteClient(argument: _propertyAPI_ClientId, callback: grpc.requestCallback<_propertyAPI_DeleteClientResponse__Output>): grpc.ClientUnaryCall;
...
export interface ClientServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  DeleteClient: grpc.handleUnaryCall<_propertyAPI_ClientId__Output, _propertyAPI_DeleteClientResponse>;
...
export interface ClientServiceDefinition extends grpc.ServiceDefinition {
  ...
  DeleteClient: MethodDefinition<_propertyAPI_ClientId, _propertyAPI_DeleteClientResponse, _propertyAPI_ClientId__Output, _propertyAPI_DeleteClientResponse__Output>
